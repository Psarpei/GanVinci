...
def train(args, feat, device, mean_latent, optimizer, scheduler, clip_model, text_tokens, cos_sim, clip_loss_s, mse):
    ...
    for i in range(1, args.iterations +1):
        ...
        _ , edit_sample, mask, latent, latent_feat = feat(
            [sample_z],
        ...
        edit_resized = F.interpolate(edit_sample,
                                     size=(224, 224),
                                     mode='bilinear')
        ...
        if(i in [10, 1000, 2000, 5000, 10000, 20000]):
            torch.save(
                        {
...
if __name__ == "__main__":
    ...
    train(args, feat, device, mean_latent, optimizer, scheduler, clip_model, text_tokens, cos_sim, clip_loss_s, mse)